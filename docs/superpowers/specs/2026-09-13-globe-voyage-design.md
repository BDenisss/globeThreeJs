...
- Pour chaque segment entre étapes consécutives, un **pointillé doré** posé à l'altitude 1,10 (au-dessus du plateau des continents) : petits cylindres (ou segments d'un `LineSegments` épais via `Line2` de three/examples) de longueur 0,018 séparés de 0,014, couleur `#D9B65C`.
